...
true potential                        & \emph{$N_{*}$:} & 20,000 & & \\
                                            & \NEW{\emph{Numerical accuracy:}} & & \NEW{$N_x=20, N_v = 28, n_\sigma = 5.5$} & 
\enddata
\end{deluxetable}
\clearpage
\end{landscape}

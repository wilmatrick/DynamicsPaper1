...
uncertainties 			 	& \emph{Uncertainties:}		& only proper motion uncertainties & proper motion uncertainties & \\
					...
					& \emph{$N_{*}$:} & 10,000 & & \\
\tableline
Test \testlabel{test:isoSphFlexMix}{7} :       & \emph{Potential:} & \OLD{\texttt{Iso-Pot}}\NEW{\texttt{DHB-Pot}} & \OLD{\texttt{Iso-Pot}, all parameters free}\NEW{\texttt{DHB-Pot}, free parameters:} & Figures \ref{fig:isoSphFlexMix_mockdata_residuals}, \ref{fig:isoSphFlexMixCont} \& \ref{fig:isoSphFlexMixDiff}\\

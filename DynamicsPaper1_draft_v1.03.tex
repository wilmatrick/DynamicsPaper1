...
\renewcommand{\dbltopfraction}{1.0} %for maximum fraction of space for figure
...
\title{Action-based Dynamical Models for the Milky Way Disk with \emph{RoadMapping}\\and our imperfect Knowledge of the "Real World"\\}
...
%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
%Results
\input{docs/results_intro_v1.03}
...
\input{docs/results_mixedDFs_v1.04}
...
\input{docs/acknowledgments_v.1.01}
%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

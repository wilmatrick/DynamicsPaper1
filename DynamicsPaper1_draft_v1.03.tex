...
%\include{{docs/dynamical_modelling_mockdata_v1.02}}
...
\include{{docs/results_incompleteness_v1.02}}
%\include{{docs/results_errors_v1.02}}
\include{{docs/results_mixedDFs_v1.02}}
...
\bibitem[Sanders \& Binney(2015)]{san15} [TO DO] Extended distribution functions for our Galaxy
\end{thebibliography}

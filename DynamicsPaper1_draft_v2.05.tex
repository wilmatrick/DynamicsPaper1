...
%% Abbreviations
\shorttitle{Action-based Dynamical Modelling for the Milky Way: A Case Study}
...
%\title{Action-based Dynamical Modelling of the Milky Way Disk\\and our Imperfect Knowledge of the ``Real World''\\}
\title{Action-based Dynamical Modelling for the Milky Way: A Case Study \\}
...
%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
% Abstract
\input{docs/abstract_v2.05} %[TO DO: edit]
%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
\input{docs/results_errors_v2.05} %[TO DO: edit]
...
\\\HW{[TO DO: How to reference Galactic Dynamics????]}
\\\Jo{[TO DO: How to reference bovy12abcd in literature list????]}
%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

...
There is a variety of practical approaches to dynamical modelling of discrete collisionless tracers, such as the stars in the MW, e.g., Jeans modelling (\citealt{1989MNRAS.239..605K}; \citealt{2012ApJ...756...89B}; \citealt{2012MNRAS.425.1445G}; \citealt{2013ApJ...772..108Z}; \citealt{2015MNRAS.452..956B}), action-based DF modelling (with parametric DFs: \citealt{2013ApJ...779..115B}; \citealt{2014MNRAS.445.3133P}; \citealt{2015MNRAS.449.3479S}; \citealt{2016MNRAS.tmp..817D}; with marginalization over non-parametric DFs: \citealt{2014MNRAS.437.2230M}), torus modelling (\citealt{2008MNRAS.390..429M}; \citealt{2012MNRAS.419.2251M}; \citealt{2013MNRAS.433.1411M}), or made-to-measure modelling (\citealt{1996MNRAS.282..223S}; \citealt{2007MNRAS.376...71D}; \citealt{2014MNRAS.443.2112H}). Most of them---explicitly or implicitly---describe the stellar distribution through a DF. Not all of them avoid binning to exploit the full discrete information content of the data.
...
%====================
\begin{figure*}[!htbp]
\includegraphics[width=\textwidth]{reference_potentials-eps-converted-to.pdf}
...
\begin{figure*}[!htbp]
\centering
\plotone{likelihood_normalisation_accuracy-eps-converted-to.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\columnwidth]{isoSphFlexErrConv_MC_vs_error_3-eps-converted-to.pdf}
...
An analogous but one-dimensional treatment of measurement uncertainties in only $v_z$ was already applied by BR13. Similar approaches ignoring measurement uncertainties in the likelihood normalisation and using MC sampling of the error ellipses were also used by \citet{2013MNRAS.433.1411M} and \citet{2016MNRAS.tmp..817D}. In Section \ref{sec:results_errors}, Figure \ref{fig:isoSphFlexErrConv_bias_vs_SE} (Test \ref{test:isoSphFlexErrConv_bias_vs_SE} in Table \ref{tbl:tests}), we will investigate the breakdown of our approximation for non-negligible distance uncertainties.
...
\begin{figure*}[!htbp]
\centering
\includegraphics[width=0.7\textwidth]{isoSphFlex_short_hot_2kpc_triangle_MCMC-eps-converted-to.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\columnwidth]{isoSph_CLT_2-eps-converted-to.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\columnwidth]{wedgesVol_bias_vs_SE-eps-converted-to.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\columnwidth]{MWbdhIncompR_violins-eps-converted-to.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\columnwidth]{isoSphFlexErrConv_SE_vs_error-eps-converted-to.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\columnwidth]{isoSphFlexErrConv_bias_vs_SE-eps-converted-to.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\columnwidth]{isoSphFlexErrSyst_offset_vs_error-eps-converted-to.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\columnwidth]{MWdhbMix_mockdata_residuals-eps-converted-to.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\columnwidth]{MWbdhMixDiff_hot_2kpc_0.6_a_residual_RvsZ-eps-converted-to.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.55]{MWbdhMixCont_violins-eps-converted-to.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.55]{MWbdhMixDiff_violins-eps-converted-to.pdf}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\columnwidth]{MW14vsKKS2New_mockdata_residuals-eps-converted-to.pdf}
...
\begin{figure*}[!htb]
\centering
\includegraphics[width=1\textwidth]{MW14vsKKS2New_b_contours_compare_withsurfdens_2-eps-converted-to.pdf}
...
%====================
\begin{figure*}[!htbp]
\includegraphics[width=1\textwidth]{MW14vsKKS2New_violins-eps-converted-to.pdf}
...
\centering
\includegraphics[width=\textwidth]{kks2WedgeEx_mockdata_actions-eps-converted-to.pdf}
...
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\textwidth]{kks2WedgeEx_mockdata_xv-eps-converted-to.pdf}

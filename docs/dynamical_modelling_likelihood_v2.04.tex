...
\end{eqnarray*}
As qDF parameters (see Section \ref{sec:qDF}) we use
\begin{eqnarray}
p_\text{DF} := \{&& \ln \left(h_R/8\text{kpc}\right), \nonumber\\
&& \ln \left(\sigma_{R,0}/220\text{km s$^{-1}$}\right), \ln \left(\sigma_{z,0}/220\text{km s$^{-1}$}\right), \nonumber\\
&& \ln \left(h_{\sigma,R}/8\text{kpc}\right), \ln \left(h_{\sigma,z}/8\text{kpc}\right)\ \}.\label{eq:p_DF}
\end{eqnarray}
...
\begin{eqnarray}
&&\delta_{M_{tot}} \nonumber\\
&&\equiv \frac{M_\text{tot,approx}(N_x,N_v,N_\sigma) -  M_\text{tot} }{M_\text{tot}}\label{eq:relerrlikelihood}
\end{eqnarray}

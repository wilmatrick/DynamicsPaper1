...
in steady state. With the exception of the test suite on measurement uncertainties in \S\ref{sec:results_errors}, we assume that phase-space uncertainties are negligible. All tests are also summarized in Table \ref{tbl:tests}. 

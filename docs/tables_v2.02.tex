...
Influence of            & \emph{\MAP:}          & 2 \MAPs "hot" or "cold" qDF   &   & Figure \ref{fig:mockdatadistr}\\
...
\tableline
\textcircled{10}        & \emph{Potential:}     & "Iso-Pot" & "Iso-Pot", all parameters free & Figure \ref{fig:triangleplot}\\
...
\tableline
\textcircled{2}			& \emph{Potential:}     & "Iso-Pot" & "Iso-Pot", free parameter: $b$ & Figure \ref{fig:sqrtN}\\
...
\tableline
\textcircled{3}         & \emph{Potential:}     & 2 "Iso-Pot" with & "Iso-Pot", free parameter: $b$ & Figure \ref{fig:centrallimittheorem}\\
...
\tableline
\textcircled{4} 		& \emph{Potential:} 	& i) "Iso-Pot", ii) "MW13-Pot" or iii) "KKS-Pot" 	& i) "Iso-Pot", all parameters free & Figure \ref{fig:wedFlexVol_bias_vs_SE} \\
...
Influence of            & \emph{\MAP:}          & 2 \MAPs, a) "hot" or b) "cool" qDF & qDF, all parameters free &  Figures \ref{fig:isoSphFlexIncompR_mockdata} \& \ref{fig:isoSphFlexIncompZ_mockdata} \\
...
\tableline
\textcircled{6} 		& \emph{Potential:} 	& "Iso-Pot" & "Iso-Pot, all parameters free" & Figure \ref{fig:isoSphFlexErrConv_MC_vs_error}\\
...
\tableline
\textcircled{12}
Testing the 			& \emph{Potential:} 	& "Iso-Pot" & "Iso-Pot, all parameters free" & Figure \ref{fig:isoSphFlexErrConv_bias_vs_SE}\\
...
\tableline
\textcircled{11}	& \emph{Potential:}		& "Iso-Pot" & "Iso-Pot", all parameters free & Figure \ref{fig:isoSphFlexErrSyst}\\
...
Deviations in the       & \emph{\MAP:}      & mix of two qDFs & single qDF, all parameters free & Figure \ref{fig:isoSphFlexMix_mockdata_residuals}\\
assumed DF              &                   & \emph{Example 1:} with fixed qDF parameters,  & & Analysis results:\\
from the                &                   & but 20 different mixing rates: & & \ref{fig:isoSphFlexMixCont} \& Figure \ref{fig:isoSphFlexMixDiff}\\
